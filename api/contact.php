...
<div style="border:1px solid #e5e5e5;border-top:none;padding:32px;border-radius:0 0 16px 16px;">
    ...
    <div style="text-align:center;margin-top:28px;">
        <a href="mailto:' . htmlspecialchars($email) . '?subject=Re: Your inquiry at Deep Design" style="display:inline-block;background:#000;color:#fff;padding:14px 32px;border-radius:50px;text-decoration:none;font-weight:600;font-size:14px;">Reply to ' . htmlspecialchars($name) . '</a>
    </div>
...
<p style="text-align:center;color:#bbb;font-size:11px;margin-top:20px;">Deep Design &mdash; Website Notification</p>
</body></html>';
...
<div style="border:1px solid #e5e5e5;border-top:none;padding:32px;border-radius:0 0 16px 16px;">
    ...
    <p style="font-size:15px;line-height:1.7;">Thank you for reaching out to Deep Design! I\'ve received your ' . ($type === 'request' ? 'project request' : 'message') . ' and will get back to you within 24 hours.</p>
    ...
    <p style="font-size:15px;line-height:1.7;margin-top:28px;">Best regards,<br><strong>Deep Design</strong></p>
</div>
<p style="text-align:center;color:#bbb;font-size:11px;margin-top:20px;">deep-design.netlify.app</p>
</body></html>';

sendSMTP($email, "We received your inquiry - Deep Design", $userHtml);
